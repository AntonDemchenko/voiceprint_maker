...
class SincNetModel(tf.keras.Model):
    def __init__(self, options):
        ...
        self.sinc_1 = SincConv1D(options.cnn_N_filt[0], options.cnn_len_filt[0], options.fs)
        ...
        self.conv_2 = layers.Conv1D(options.cnn_N_filt[1], options.cnn_len_filt[1], strides=1, padding='valid')
        ...
        self.conv_3 = layers.Conv1D(options.cnn_N_filt[2], options.cnn_len_filt[2], strides=1, padding='valid')
